...
import { ArrowLeft, ChevronLeft, ChevronRight, Share2, Star } from 'lucide-react';
...
export default function CarDetailsPage({ params }: { params: { id: string } }) {
  ...
  const car = {
    ...
    rating: 4.5,
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas diam nam eu nulla a. Vestibulum aliquet facilisi interdum nibh blandit',
        ...
        <div className="p-4">
          ...
          <div className="mb-4 flex items-center gap-2">
            <div className="flex items-center gap-1">
              ...
              <span className="font-semibold text-orange-500">{car.rating}</span>
